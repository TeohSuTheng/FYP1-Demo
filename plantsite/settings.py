...
#SECRET_KEY = 'django-insecure-$*)jr&e)z*ukepwmmz)ozy)vz)i@g*%l%n11m_(2ersny)hz2p'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG_VALUE')=='True')

ALLOWED_HOSTS = ['127.0.0.1','digital-plant-herbarium.herokuapp.com'] #'127.0.0.1',
...
#MEDIA_ROOT is for server path to store files in the file system.
